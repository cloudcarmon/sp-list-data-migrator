...
namespace ListDataMigrator.Importer.Models
{
    public class CommandLineArguments
    {
        ...
        //public string ExportedConfigDir { get; set; }
        ...
        //[Option('g', "field-value-generator", Required = false, HelpText = "File path for the fields that have generated values.")]
        //public string FieldValueGeneratorPath { get; set; }
    }
}
